...
homicide_per_100k <- Western_Europe[4]
```
...
Western_Europe_plotting %>%
  ggplot(aes(x = Year, y = homicides_per_100k_v, color = Entity)) + 
  geom_point(alpha=0.3) + geom_smooth() + geom_jitter() + 
  labs(title = ("Homicides"),color="Country") +
  facet_wrap(~Entity) +
  theme(legend.position = "bottom")
```
